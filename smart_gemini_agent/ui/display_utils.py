    ...
    def display_help(self):
        ...
        commands = {
            ...
            "Мониторинг и метрики": {
                "/metrics": "Показать сводку метрик производительности агента",
                "/traces [N]": "Показать последние N трассировок",
            },
            "Память и поиск": {
                "/memory_stats": "Статистика долговременной памяти",
                "/memory_search <запрос>": "Поиск похожих взаимодействий в памяти",
                "/memory_clear": "Очистить долговременную память",
            },
            "Планирование задач": {
                "/plan <задача>": "Создать план выполнения сложной задачи",
                "/run_plan": "Выполнить текущий план до завершения (с подтверждением)",
                "/next": "Выполнить следующую доступную подзадачу из плана",
            },
            "Безопасность": {
                "/security_stats": "Показать статистику системы безопасности (Guardrails)",
            },
            "Управление зацикливанием": {
                "/продолжить | /continue": "Включить режим игнорирования зацикливания",
                "/остановить | /stop_loop": "Выключить режим игнорирования зацикливания",
                "/loop_status": "Проверить статус режима игнорирования зацикливания",
            },
            "Файловые операции": {
